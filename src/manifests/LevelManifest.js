/*
Level Manifest Documentation

Standard Shapes Or Turrets
--------------------------
...
Powerups
--------
freq - frequency of shot if auto fire set to true (ticks between shots)
auto - can player hold fire down to fire?
speed - speed of bullet
damage - damage done to enemy
invincible - does bullet disappear if it hits a target
ammo - number of bullets (if -1 it is infinite)
...
LEVEL MANIFEST REFERENCE:
Standard Shape Wave (see [] for notes):
{type:"[name of shape (see reference above)]", 
    wave:{count:[number of shapes in wave], spaced:[how many ticks between each shape is dropped]},
    settings:{x:[starting X], y:[starting Y], 
        shooters:[
            {index:[index of shape that will be shooter], 
             freq:[frequency of shot in ticks (how many ticks between shots], 
             bulletType:"[type of bullet (bullet1-bullet3) - increasing damage / size / speed]"},
             ...
        ]
    }, 
    movement:
        {type:"[type of movement - (see below for variations)]",speed:[pixels moved per tick (speed)]},
    powerup:{type:"[name of powerup]",index:[which shape drops it]},
    time:[time in seconds of level when this wave is started]
}
- if no shooters, the shooters property can be left out entirely
- if no powerup for this wave set to null
- only one powerup allowed to be dropped per wave
- wave should be one minute in length

Big/Mini Boss Shape Wave (see [] for notes):
{type:"[bossSquare|bossDecagon|bossRhombus|bossTriangle|bossHexagon|bossMiniHexagon|bossMiniTriangle|bossMiniRhombus]", 
    wave:{count:[number of bosses in wave], spaced:[number of ticks between each boss drop]},
    settings:{x:[starting X location], y:[starting Y location], points:[1000|2000|5000|200 (for mini)|400 (for mini)],
        turrets:[   
            {type:"[shape for turret]",x:[x location relative to center of boss shape],y:[y location relative to center of boss shape],freq:[ticks between shots],bulletType:"[bullet1|bullet2|bullet3]"},
            ...
        ]
    },
    movement:{[same as above - except use movements that stop at some point]},
    time:58
}

Movement Variations:
Directional
movement:{type:"[down|up|left|right]]",speed:[speed of movement]}

Looping
movement:{type:"looping", r:[radius of loop circle], cx:[x center of loop circle], cy:[y center of loop circle], dir:"right", loops:[number of loops before moving out of loop and moving off stage], speed:[speed of movement], stop[true|false]}
- shapes can be moving any direction (left, right, up, down) and go into a loop. You must set cx or cy equal to starting x or y
- stop property can be left out (defaults to false)
- stop set to true will stop the movement after all loops complete - used for big boss movement

Directional and Stop
movement:{type:"[leftAndStop|rightAndStop|upAndStop|downAndStop", speed:[speed of movement], stopAt:[either the x or y to stop at]}
- used for big boss movement

Diagonal
movement:{type:"diagonal",speed:[speedof movement],angle:[angle shape will come out at (clockwise)]}

Switch (moves down or up and then double backs and goes off stage)
movement:{type:"switch", dir:"[up|down]", speed:[speed of movement], switchAt:[x or y to change to different direction]}

Diagonal and Stop (same as diagonal but stops)
movement:{type:"diagonalAndStop", angle:225, speed:4, stopAt:225}
- used for big boss movement

Kamikaze (slowly moves towards player)
movement:{type:"kamikaze", speed:1[speed of movement]}

ZigZag (same as diagonal except it bounces off edge of stage)
movement:{type:"zigzag", angle:[angle shape comes out on], speed:[speed of movement], bounces:[number of stage edge bounces before it leaves the stage]}
...
var levelManifest = [
    [
        ...
        {type:"bossMiniHexagon", 
            wave:{count:1, spaced:4},
            settings:{x:850, y:400, points:200,
                turrets:[   
                    {type:"triangle",x:0,y:0,freq:25,bulletType:"bullet1"},
                ]
            },
            movement:{type:"leftAndStop", speed:2, stopAt:300, rotate:true},
            time:30
        },
        {type:"square", 
        ...
        {type:"circle", 
            ...
            settings:{x:150, y:-30, shooters:[{index:2, freq:40, bulletType:"bullet1"}]}, 
            movement:{type:"down",speed:4},
            powerup:null,
            time:40
        },
        {type:"circle", 
            wave:{count:5, spaced:20},
            settings:{x:400, y:-50, shooters:[{index:0, freq:60, bulletType:"bullet1"}]}, 
            movement:{type:"downAndStop",speed:4,stopAt:300},
            powerup:null,
            time:43
        },
        {type:"ellipse", 
            wave:{count:4, spaced:80},
            settings:{x:650, y:850, shooters:[{index:0, freq:20, bulletType:"bullet1"},{index:3, freq:20, bulletType:"bullet1"}]}, 
    ...
    [
        ...
        {type:"ellipse", 
            ...
            settings:{x:-50, y:300, shooters:[{index:0, freq:75},{index:1, freq:75},{index:2, freq:75}]}, 
        ...
        {type:"ellipse", 
            wave:{count:3, spaced:30},
            settings:{x:850, y:300, shooters:[{index:0, freq:75},{index:1, freq:75},{index:2, freq:75}]}, 
        ...
        {type:"bossSquare", 
            ...
            settings:{x:1000, y:300, points:2000,
                turrets:[   
                    ...
                    {type:"triangle",x:100,y:100,freq:100,bulletType:"bullet1"},
                    {type:"triangle",x:-100,y:100,freq:100,bulletType:"bullet1"},
                    {type:"triangle",x:100,y:-100,freq:100,bulletType:"bullet1"},
                    {type:"triangle",x:-100,y:-100,freq:100,bulletType:"bullet1"},
                    {type:"square",x:0,y:-100,freq:100,bulletType:"bullet1"},
                    {type:"square",x:0,y:100,freq:100,bulletType:"bullet1"},
                    {type:"triangle",x:100,y:0,freq:100,bulletType:"bullet1"},
                    {type:"triangle",x:-100,y:0,freq:100,bulletType:"bullet1"}
                ]
            },
    ...
    [
        ...
        {type:"ellipse", 
            ...
            settings:{x:610, y:850, shooters:[{index:0, freq:30, bulletType:"bullet1"},{index:5, freq:30, bulletType:"bullet1"}]}, 
        ...
        {type:"ellipse", 
            ...
            settings:{x:430, y:850, points:200, 
                shooters:[
        ...
        {type:"triangle", 
            wave:{count:10, spaced:25},
            settings:{x:400, y:830, shooters:[{index:0, freq:20, bulletType:"bullet1"},{index:5, freq:20, bulletType:"bullet1"}]}, 
            movement:{type:"looping", r:50, cx:400, cy:500, dir:"up", loops:4, speed:4},
            powerup:null,
            time:28
        },
        {type:"square", 
    ...
    [
        ...
        {type:"ellipse", 
            ...
            settings:{x:400, y:-50, shooters:[{index:0, freq:60},{index:1, freq:48},{index:2, freq:60},{index:9, freq:60},{index:10, freq:60},{index:11, freq:60}]}, 
    ...
    [
        ...
        {type:"ellipse", 
            wave:{count:5, spaced:20},
            settings:{x:-50, y:200, shooters:[{index:0, freq:30, bulletType:"bullet2"}]}, 
            movement:{type:"right",speed:3},
        ...
        {type:"ellipse", 
            wave:{count:5, spaced:20},
            settings:{x:-50, y:200, shooters:[{index:0, freq:30, bulletType:"bullet3"}]}, 
            movement:{type:"right",speed:3},
            powerup:{type:"powerupSuperDouble",index:1},
            time:34
        },
    ...
    [
        ...
        {type:"ellipse", 
            wave:{count:20, spaced:25},
            settings:{x:400, y:-50, shooters:[{index:0, freq:50, bulletType:"bullet1"},{index:5, freq:100, bulletType:"bullet1"}]}, 
        ...
        {type:"star", 
            ...
            powerup:{type:"powerupLife",index:10},
            time:55
        },
        {type:"bossTriangle", 
            wave:{count:1, spaced:4},
    ...
    [
        ...
        {type:"ellipse", 
            ...
            settings:{x:600, y:-50, shooters:[{index:0, freq:35, bulletType:"bullet1"}]},
        ...
        {type:"ellipse", 
            wave:{count:6, spaced:10},
            settings:{x:200, y:-50, shooters:[{index:0, freq:35, bulletType:"bullet1"}]},
            movement:{type:"switch", dir:"down", speed:6, switchAt:675, rotate:false},
            time:36
        },
        {type:"ellipse", 
            wave:{count:10, spaced:10},
            settings:{x:300, y:-50, shooters:[{index:0, freq:35, bulletType:"bullet1"}]},
        ...
        {type:"ellipse", 
            wave:{count:6, spaced:10},
            settings:{x:350, y:850, shooters:[{index:0, freq:35, bulletType:"bullet1"}]},
        ...
        {type:"ellipse", 
            wave:{count:6, spaced:10},
            settings:{x:450, y:850, shooters:[{index:0, freq:35, bulletType:"bullet1"}]},
            movement:{type:"switch", dir:"up", speed:6, switchAt:100, rotate:true},
            time:50
        },
        {type:"bossHexagon", 
    ...
    [
        ...
        {type:"bossTriangle", 
            wave:{count:1, spaced:4},
            settings:{x:-200, y:320, points:5000,
                turrets:[   
                    {type:"nonagon",x:105,y:-105,freq:60,bulletType:"bullet2"},
                    {type:"nonagon",x:75,y:-75,freq:60,bulletType:"bullet2"},
                    {type:"nonagon",x:0,y:100,freq:70,bulletType:"bullet2"},
    ...
    [
        ...
        {type:"bossHexagon", 
            ...
            settings:{x:400, y:-200, points:2000,
                turrets:[   
                    {type:"nonagon",x:100,y:100,freq:20,bulletType:"bullet3"},
    ...
    [
        ...
        {type:"circle", 
            ...
            settings:{x:402, y:-30}, 
            movement:{type:"looping", r:200, cx:402, cy:400, dir:"down", loops:1.25, speed:4, rotate:true},
            powerup:null,
            time:20
        },
        {type:"circle", 
            wave:{count:10, spaced:40},
            settings:{x:398, y:-30}, 
            movement:{type:"looping", r:200, cx:398, cy:400, dir:"down", loops:1.75, speed:4, rotate:true},
            powerup:null,
            time:20
        },
        {type:"bossMiniTriangle", 
        ...
        {type:"rectangle", 
            ...
            settings:{x:750, y:820},
            movement:{type:"zigzag", speed:4, angle:215, bounces:20, rotate:true},
        ...
        {type:"rectangle", 
            wave:{count:20, spaced:2},
            settings:{x:50, y:820},
            movement:{type:"zigzag", speed:4, angle:300, bounces:20, rotate:true},
            powerup:{type:"powerupShield",index:4},
            time:40
        },
        {type:"bossSquare", 
    ...
    [
        ...
        {levelTitle:"Trapped!",
            ...
            settings:{x:400, y:-30, shooters:[
                {index:0, freq:30, bulletType:"bullet1"}
            ]},   
        ...
        {type:"ellipse",
            ...
            powerup:{type:"powerupLife",index:15},
            time:14
        },
        {type:"square",
            wave:{count:30, spaced:30},
            settings:{x:400, y:-30, shooters:[
                {index:10, freq:60, bulletType:"bullet2"}
            ]},   
        ...
        {type:"bossRhombus", 
            ...
            settings:{x:700, y:1000, points:5000,
                turrets:[   
                    ...
                    {type:"nonagon",x:85,y:85,freq:22,bulletType:"bullet1"},
                    {type:"nonagon",x:-85,y:85,freq:24,bulletType:"bullet1"},
                    {type:"nonagon",x:85,y:-85,freq:26,bulletType:"bullet1"},
                    {type:"nonagon",x:-85,y:-85,freq:28,bulletType:"bullet1"}
                ]
            },
            movement:{type:"kamikaze", speed:2, rotate:true},
            time:65
    ...
    [
        ...
        {levelTitle:"Deja-vu!",
            ...
            settings:{x:400, y:-50, 
                shooters:[
                    {index:0, freq:20, bulletType:"bullet2"},
                    {index:2, freq:20, bulletType:"bullet2"},
                    {index:4, freq:20, bulletType:"bullet2"},
                    {index:6, freq:20, bulletType:"bullet2"},
                    {index:8, freq:20, bulletType:"bullet2"}
                ]}, 
            movement:{type:"down",speed:6},
            powerup:null,
            time:2
        },
        {type:"square", 
            wave:{count:5, spaced:15},
            settings:{x:-50, y:250, 
                shooters:[
                    {index:0, freq:20, bulletType:"bullet1"},
                    {index:2, freq:20, bulletType:"bullet1"},
                    {index:4, freq:20, bulletType:"bullet1"}
                ]}, 
            movement:{type:"right",speed:6},
            powerup:null,
            time:5
        },
        {type:"circle", 
            ...
            settings:{x:830, y:500, 
                shooters:[
                    {index:0, freq:10, bulletType:"bullet1"},
                    {index:2, freq:10, bulletType:"bullet1"},
                    {index:4, freq:10, bulletType:"bullet1"}
                ]}, 
            movement:{type:"left",speed:6},
            powerup:{type:"powerupLaser",index:2},
            time:10
        },
        {type:"square", 
        ...
        {type:"circle", 
            wave:{count:5, spaced:20},
            settings:{x:550, y:830, shooters:[{index:2, freq:8}]}, 
            movement:{type:"up", speed:4},
            powerup:null,
            time:22
        },
        {type:"bossMiniHexagon", 
            ...
            settings:{x:-50, y:400, points:200,
                turrets:[   
                    {type:"rhombus",x:0,y:0,freq:25,bulletType:"bullet3"},
                ]
            },
            movement:{type:"rightAndStop", speed:4, stopAt:500, rotate:true},
            time:30
        },
        {type:"square", 
            wave:{count:8, spaced:15},
            settings:{x:830, y:450, 
                shooters:[
                    {index:0, freq:30},
                    {index:1, freq:30},
                    {index:2, freq:30},
            ...
            movement:{type:"leftAndStop", rotate:true, speed:6, stopAt:200},
            powerup:null,
            time:34
        },
        {type:"circle", 
            wave:{count:6, spaced:15},
            settings:{x:150, y:-30, shooters:[{index:2, freq:10, bulletType:"bullet1"}]}, 
            movement:{type:"down",speed:6},
            powerup:null,
            time:40
        },
        {type:"circle", 
            ...
            settings:{x:400, y:-50, 
                shooters:[
                    {index:1, freq:10, bulletType:"bullet2"},
                    {index:3, freq:10, bulletType:"bullet2"},
                    {index:4, freq:10, bulletType:"bullet2"}
                ]}, 
            movement:{type:"downAndStop",speed:4,stopAt:300},
            powerup:{type:"powerupLife",index:2},
            time:43
        ...
        {type:"ellipse", 
            wave:{count:1, spaced:30},
            settings:{x:650, y:850, shooters:[{index:0, freq:15, bulletType:"bullet3"}]}, 
            movement:{type:"upAndStop",speed:4,stopAt:200},
            powerup:{type:"poweruRapid",index:2},
            time:46
        },
        {type:"square", 
            wave:{count:15, spaced:25},
            settings:{x:200, y:-30}, 
            movement:{type:"zigzag", angle:55, speed:10, bounces:20, rotate:true},
            powerup:null,
            time:50
        },
        {type:"bossHexagon", 
            ...
            settings:{x:-200, y:400, points:5000,
                turrets:[   
                    {type:"rectangle",x:0,y:0,freq:30,bulletType:"nonagon"},
                    {type:"rhombus",x:100,y:100,freq:15,bulletType:"bullet2"},
                    {type:"rhombus",x:-100,y:100,freq:15,bulletType:"bullet2"},
                    {type:"rhombus",x:100,y:-100,freq:15,bulletType:"bullet2"},
                    {type:"rhombus",x:-100,y:-100,freq:15,bulletType:"bullet2"}
                ]
            },
            movement:{type:"rightAndStop", speed:8, stopAt:400, rotate:true},
            time:58
        }
    ],
    [
        ...
        {levelTitle:"Plaid!",
            ...
            settings:{x:-30, y:600, 
                shooters:[
                    {index:0, freq:40, bulletType:"bullet2"},
                    {index:2, freq:25, bulletType:"bullet1"},
                    {index:4, freq:40, bulletType:"bullet2"},
                    {index:6, freq:20, bulletType:"bullet1"},
                    {index:8, freq:45, bulletType:"bullet2"}
                ]}, 
            movement:{type:"zigzag", angle:0, bounces:20, speed:4},
            powerup:{type:"powerupSpread",index:4},
            time:2
        },
        {type:"pentagon", 
            wave:{count:20, spaced:20},
            settings:{x:830, y:500}, 
            movement:{type:"zigzag", angle:180, bounces:20, speed:3},
            powerup:{type:"powerupLife",index:9},
            time:12
        },
        {type:"ellipse", 
            wave:{count:20, spaced:30},
            settings:{x:-40, y:400, 
                shooters:[
                    ...
                    {index:2, freq:35, bulletType:"bullet1"},
                    {index:4, freq:50, bulletType:"bullet1"},
                    {index:6, freq:30, bulletType:"bullet1"},
                    {index:8, freq:45, bulletType:"bullet1"}
                ]}, 
            movement:{type:"zigzag", angle:0, bounces:20, speed:2},
            powerup:null,
            time:20
        },
        {type:"triangle", 
            ...
            settings:{x:-30, y:300, 
                shooters:[
                    ...
                    {index:2, freq:75, bulletType:"bullet1"},
                    {index:4, freq:50, bulletType:"bullet1"},
                    {index:6, freq:75, bulletType:"bullet1"},
                    {index:8, freq:100, bulletType:"bullet1"}
                ]}, 
            movement:{type:"zigzag", angle:0, bounces:20, speed:2},
            powerup:{type:"powerupLife",index:4},
            time:28
        ...
        {type:"circle", 
            ...
            movement:{type:"zigzag", angle:90, bounces:20, speed:3},
            powerup:{type:"powerupSuperBounce",index:4},
            time:36
        },
        {type:"square", 
            wave:{count:10, spaced:30},
            ...
            movement:{type:"zigzag", angle:90, bounces:20, speed:3},
            powerup:{type:"powerupSuperSpread",index:9},
            time:44
        },
        {type:"bossHexagon", 
            wave:{count:1, spaced:60},
            settings:{x:300, y:1000, points:5000,
                turrets:[   
                    {type:"nonagon",x:100,y:100,freq:30,bulletType:"bullet1"},
                    {type:"nonagon",x:-100,y:100,freq:20,bulletType:"bullet1"},
                    {type:"nonagon",x:100,y:-100,freq:30,bulletType:"bullet1"},
                    {type:"nonagon",x:-100,y:-100,freq:20,bulletType:"bullet1"}
                ]
            },
            movement:{type:"upAndStop", speed:2, stopAt:250, rotate:true},
            time:52
        },
        {type:"bossHexagon", 
            wave:{count:1, spaced:60},
            settings:{x:500, y:1000, points:5000,
                turrets:[   
                    {type:"nonagon",x:100,y:100,freq:30,bulletType:"bullet1"},
                    {type:"nonagon",x:-100,y:100,freq:20,bulletType:"bullet1"},
                    {type:"nonagon",x:100,y:-100,freq:30,bulletType:"bullet1"},
    ...
    [
        {levelTitle:"Boss!",
            ...
            settings:{x:-30, y:400, 
                shooters:[
                    {index:0, freq:40, bulletType:"bullet2"},
                    {index:4, freq:45, bulletType:"bullet2"}
                ]}, 
            movement:{type:"zigzag", angle:36, bounces:20, speed:4},
            powerup:{type:"powerupSpread",index:4},
            time:2
        },
        {type:"bossRhombus", 
        ...
        {type:"bossHexagon", 
            ...
            settings:{x:-200, y:400, points:5000,
                turrets:[   
                    ...
                    {type:"rhombus",x:-100,y:-100,freq:25,bulletType:"bullet2"}
                ]
            },
            movement:{type:"rightAndStop", speed:2, stopAt:400, rotate:true},
            time:16
        ...
        {type:"bossSquare", 
            wave:{count:5, spaced:30},
            settings:{x:-200, y:-200, points:5000,
                turrets:[   
                    {type:"nonagon",x:0,y:0,freq:35,bulletType:"bullet2"},
                    {type:"nonagon",x:85,y:85,freq:25,bulletType:"bullet2"},
                    {type:"nonagon",x:-85,y:85,freq:35,bulletType:"bullet2"},
