var levelManifest = [
    [
        ...
        {type:"circle", 
            ...
            settings:{x:500, y:0, hp:4, shooters:[{index:0, freq:100}]}, 
        ...
        */
        ...
        {type:"bossDecagon", 
            ...
            settings:{x:-200, y:250, points:1000,
                turrets:[   
                    {type:"circle",x:0,y:0,hp:2,freq:100},
                    {type:"circle",x:100,y:100,hp:2,freq:150},
                    {type:"circle",x:-100,y:100,hp:2,freq:50},
                    {type:"circle",x:100,y:-100,hp:2,freq:200},
                    {type:"circle",x:-100,y:-100,hp:2,freq:125}
                ]
            },
